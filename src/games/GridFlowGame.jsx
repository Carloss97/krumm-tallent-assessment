...
export const GRID_LEVELS = [
  // ── Level 1 ─ Introducción: recoger y entregar ──
  withCityWalls({
    difficulty: 'easy',
    cols: 12,
    rows: 12,
    targets: [
      { id:1, x:9, y:6, color:'#ef4444', points:100, dropZone:{x:3,y:6} },
    ],
    stations: [],
    energyDrain: 0,
    timeLimit: 40,
    ...
    [0,0,11,0],[0,1,11,1],[0,2,4,2],[6,2,11,2],[0,3,3,3],[8,3,11,3],[0,4,2,4],[9,4,11,4],
    [0,5,2,5],[10,5,11,5],[0,6,1,6],[11,6,11,6],[0,7,2,7],[10,7,11,7],[0,8,2,8],[9,8,11,8],
    [0,9,3,9],[8,9,11,9],[0,10,4,10],[6,10,11,10],[0,11,11,11]
  ]),

  // ── Level 2 ─ Múltiples destinos ──
  withCityWalls({
    difficulty: 'easy',
    cols: 14,
    rows: 14,
    targets: [
      { id:1, x:5, y:3, color:'#ef4444', points:110, dropZone:{x:3,y:7} },
      { id:2, x:9, y:7, color:'#3b82f6', points:120, dropZone:{x:3,y:7} },
    ],
    stations: [],
    energyDrain: 0,
    timeLimit: 50,
    ...
    [0,0,13,0],[0,1,13,1],[0,2,4,2],[10,2,13,2],[0,3,3,3],[11,3,13,3],[0,4,2,4],[11,4,13,4],
    [0,5,2,5],[7,5,7,5],[12,5,13,5],[0,6,1,6],[12,6,13,6],[0,7,1,7],[13,7,13,7],[0,8,1,8],[12,8,13,8],
    [0,9,2,9],[9,9,13,9],[0,10,2,10],[8,10,13,10],[0,11,3,11],[7,11,13,11],[0,12,4,12],[6,12,13,12],[0,13,13,13]
  ]),

  // ── Level 3 ─ Gestión de energía ──
  withCityWalls({
    difficulty: 'easy',
    cols: 14,
    rows: 14,
    targets: [
      { id:1, x:9, y:3, color:'#ef4444', points:130, dropZone:{x:3,y:3} },
      { id:2, x:5, y:7, color:'#3b82f6', points:135, dropZone:{x:3,y:3} },
      { id:3, x:11, y:7, color:'#10b981', points:140, dropZone:{x:3,y:3} },
    ],
    stations: [{ x:6, y:7 }, { x:10, y:7 }],
    energyDrain: 0.6,
    timeLimit: 55,
    startPos: { x:3, y:3 },
  }, [
    [0,0,13,0],[0,1,13,1],[0,2,2,2],[10,2,13,2],[0,3,1,3],[11,3,13,3],[0,4,1,4],[11,4,13,4],
    [0,5,1,5],[7,5,7,5],[11,5,13,5],[0,6,1,6],[12,6,13,6],[0,7,1,7],[13,7,13,7],[0,8,2,8],[12,8,13,8],
    [0,9,3,9],[7,9,7,9],[11,9,13,9],[0,10,3,10],[11,10,13,10],[0,11,3,11],[11,11,13,11],
    [0,12,4,12],[10,12,13,12],[0,13,13,13]
  ]),

  // ── Level 4 ─ Rutas extendidas ──
  withCityWalls({
    difficulty: 'medium',
    cols: 16,
    rows: 15,
    targets: [
      { id:1, x:10, y:12, color:'#ef4444', points:150, dropZone:{x:3,y:12} },
      { id:2, x:13, y:7, color:'#3b82f6', points:155, dropZone:{x:3,y:12} },
      { id:3, x:3, y:3, color:'#10b981', points:160, dropZone:{x:3,y:12} },
    ],
    stations: [{ x:6, y:7 }, { x:10, y:7 }, { x:8, y:2 }],
    energyDrain: 0.9,
    timeLimit: 65,
    startPos: { x:3, y:12 },
  }, [
    [0,0,15,0],[0,1,15,1],[0,2,2,2],[11,2,15,2],[0,3,1,3],[12,3,15,3],[0,4,2,4],[12,4,15,4],
    [0,5,2,5],[8,5,8,5],[12,5,15,5],[0,6,3,6],[14,6,15,6],[0,7,4,7],[15,7,15,7],[0,8,4,8],[14,8,15,8],
    [0,9,4,9],[8,9,8,9],[12,9,15,9],[0,10,4,10],[8,10,8,10],[12,10,15,10],[0,11,2,11],[12,11,15,11],
    [0,12,1,12],[12,12,15,12],[0,13,2,13],[11,13,15,13],[0,14,15,14]
  ]),

  // ── Level 5 ─ Ciudad con calles y callejones ──
  withCityWalls({
    difficulty: 'medium',
    cols: 16,
    rows: 16,
    targets: [
      { id:1, x:6, y:3, color:'#ef4444', points:170, dropZone:{x:3,y:8} },
      { id:2, x:6, y:13, color:'#3b82f6', points:170, dropZone:{x:3,y:8} },
      { id:3, x:10, y:8, color:'#10b981', points:180, dropZone:{x:3,y:8} },
    ],
    stations: [{ x:6, y:8 }, { x:10, y:8 }],
    energyDrain: 1.1,
    timeLimit: 72,
    startPos: { x:3, y:8 },
  }, [
    [0,0,15,0],[0,1,15,1],[0,2,5,2],[14,2,15,2],[0,3,4,3],[15,3,15,3],[0,4,4,4],[14,4,15,4],
    [0,5,4,5],[8,5,10,5],[14,5,15,5],[0,6,4,6],[8,6,9,6],[13,6,15,6],[0,7,2,7],[13,7,15,7],
    [0,8,1,8],[12,8,15,8],[0,9,2,9],[13,9,15,9],[0,10,4,10],[8,10,9,10],[13,10,15,10],
    [0,11,4,11],[8,11,10,11],[14,11,15,11],[0,12,4,12],[14,12,15,12],[0,13,4,13],[15,13,15,13],
    [0,14,5,14],[14,14,15,14],[0,15,15,15]
  ]),

  // ── Level 6 ─ Priorización y eficiencia ──
  withCityWalls({
    difficulty: 'hard',
    cols: 17,
    rows: 16,
    targets: [
      { id:1, x:6, y:5, color:'#ef4444', points:200, dropZone:{x:3,y:8} },
      { id:2, x:6, y:11, color:'#3b82f6', points:205, dropZone:{x:3,y:8} },
      { id:3, x:11, y:5, color:'#10b981', points:210, dropZone:{x:3,y:8} },
      { id:4, x:14, y:8, color:'#f59e0b', points:220, dropZone:{x:3,y:8} },
    ],
    stations: [{ x:9, y:8 }, { x:9, y:5 }],
    energyDrain: 1.3,
    timeLimit: 85,
    startPos: { x:3, y:8 },
  }, [
    [0,0,16,0],[0,1,16,1],[0,2,16,2],[0,3,16,3],[0,4,5,4],[15,4,16,4],[0,5,4,5],[16,5,16,5],
    [0,6,3,6],[16,6,16,6],[0,7,2,7],[16,7,16,7],[0,8,1,8],[16,8,16,8],[0,9,2,9],[15,9,16,9],
    [0,10,3,10],[13,10,16,10],[0,11,4,11],[13,11,16,11],[0,12,5,12],[12,12,16,12],
    [0,13,16,13],[0,14,16,14],[0,15,16,15]
  ]),

  // ── Level 7 ─ Optimización crítica final ──
  withCityWalls({
    difficulty: 'hard',
    cols: 18,
    rows: 17,
    targets: [
      { id:1, x:6, y:12, color:'#ef4444', points:250, dropZone:{x:9,y:12} },
      { id:2, x:12, y:12, color:'#3b82f6', points:250, dropZone:{x:9,y:12} },
      { id:3, x:6, y:5, color:'#10b981', points:260, dropZone:{x:9,y:12} },
      { id:4, x:12, y:5, color:'#f59e0b', points:270, dropZone:{x:9,y:12} },
      { id:5, x:3, y:9, color:'#8b5cf6', points:280, dropZone:{x:9,y:12} },
    ],
    stations: [{ x:9, y:9 }, { x:9, y:5 }],
    energyDrain: 1.6,
    timeLimit: 98,
    startPos: { x:9, y:12 },
  }, [
    [0,0,17,0],[0,1,17,1],[0,2,17,2],[0,3,17,3],[0,4,2,4],[16,4,17,4],[0,5,1,5],[17,5,17,5],
    [0,6,1,6],[17,6,17,6],[0,7,1,7],[17,7,17,7],[0,8,1,8],[17,8,17,8],[0,9,1,9],[17,9,17,9],
    [0,10,1,10],[17,10,17,10],[0,11,1,11],[17,11,17,11],[0,12,1,12],[17,12,17,12],
    [0,13,2,13],[16,13,17,13],[0,14,17,14],[0,15,17,15],[0,16,17,16]
  ]),
];
