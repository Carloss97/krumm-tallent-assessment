...
export const generateDummyReportData = () => {
  ...
  return {
    ...
    cpt_game_4: mkGamePayload({
      ...
      errors: 3,
      duration: 241000,
      details: { pops: 1, securedPoints: 120 },
      hesitationCount: 5,
      avgVelocity: 129,
      avgJerk: 840,
      moves: 118,
    ...
    rsh_game_6: mkGamePayload({
      ...
      errors: 4,
      duration: 272000,
      details: { efficiency: 78, energyUsed: 210, packetsDelivered: 4 },
      hesitationCount: 42, // Trigger hesitation signal
      avgVelocity: 147,
      avgJerk: 910,
      moves: 115,
      clicks: 18,
    ...
    sjt_game_7: mkGamePayload({
      ...
      errors: 3,
      duration: 233000,
      details: { efficiency: 84, totalMoves: 14, antennasLit: 6 },
      hesitationCount: 5,
      avgVelocity: 122,
      avgJerk: 780,
      moves: 102,
