...
const DemoShell = () => {
  ...
  const demoCopy = {
    es: {
      interactiveDemo: 'Evaluación interactiva',
      selectGames: 'Selecciona tus juegos',
      demoLockNotice: 'Versión de evaluación: 3 juegos disponibles.',
      lockedGameLabel: 'No disponible',
      ...
      continueButton: 'Comenzar evaluación',
    ...
    en: {
      interactiveDemo: 'Interactive Assessment',
      selectGames: 'Select your games',
      demoLockNotice: 'Assessment version: 3 games available.',
      lockedGameLabel: 'Not available',
