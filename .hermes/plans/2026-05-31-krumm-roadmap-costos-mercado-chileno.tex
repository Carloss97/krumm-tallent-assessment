...
\usepackage[a4paper,margin=1.65cm,headheight=18pt,includeheadfoot]{geometry}
\usepackage[table]{xcolor}
\usepackage{array,tabularx,longtable,booktabs,makecell,multirow,adjustbox,pdflscape,graphicx}
\usepackage{enumitem,fancyhdr,lastpage,hyperref}
...
\hypersetup{colorlinks=true, linkcolor=KBlueDark, urlcolor=KBlueDark, pdftitle={KRUMM Roadmap - Costos mercado chileno}, pdfauthor={KRUMM / Hermes Agent}}
\pagestyle{fancy}\fancyhf{}\lhead{\textcolor{KMuted}{KRUMM Talent Assessment}}\rhead{\textcolor{KMuted}{Mercado chileno}}\cfoot{\textcolor{KMuted}{\thepage\ de \pageref{LastPage}}}
\renewcommand{\headrulewidth}{0.3pt}\renewcommand{\arraystretch}{1.20}\setlength{\parindent}{0pt}\setlength{\parskip}{5pt}
\setlist[itemize]{leftmargin=1.2em,itemsep=1pt,topsep=2pt}\setlist[enumerate]{leftmargin=1.5em,itemsep=1pt,topsep=2pt}
...
{\LARGE\bfseries Revisión de costos para mercado chileno}\\[0.2cm]
{\Large Sueldos, UF, CLP y cash-out local para MVP piloto}
\end{minipage}
\hfill
...
\end{minipage}
\vspace{0.8cm}
\noindent\colorbox{KDark}{\parbox{\dimexpr\linewidth-2\fboxsep}{\textcolor{white}{\large Documento financiero para MVP piloto / private beta en Chile}}}
\vspace{0.7cm}
\begin{tabularx}{\linewidth}{@{}>{\bfseries\color{KMuted}}l X@{}}
Fecha de revisión: & 2026-05-31 \\
Moneda principal: & Peso chileno (CLP); equivalencias en UF y USD. \\
UF usada: & CLP 40.610,69 por UF, mindicador.cl. \\
Dólar usado: & CLP 892,89 por USD, dólar observado 2026-05-29 vía mindicador.cl. \\
Supuesto clave: & equipo fundador/interno absorbe su propio trabajo; se valoriza como costo de oportunidad, no como cash-out. \\
\end{tabularx}
\vfill
\callout{KWarn}{\textbf{Nota.} Los montos cash son netos/sin IVA salvo indicación. Si el IVA no es recuperable como crédito fiscal, el desembolso bruto puede subir hasta 19\% en servicios afectos.}
\end{titlepage}
...
\callout{KBlue}{\textbf{Conclusión principal.} Con equipo fundador/interno absorbido, el cash-out chileno recomendado para completar H1--H7 queda en \textbf{CLP 9,66 MM--50,54 MM}, equivalente a \textbf{238 UF--1.245 UF}. Si el IVA no es recuperable, el desembolso bruto puede subir a \textbf{CLP 11,50 MM--60,15 MM}.}

El costo de oportunidad interno valorizado con sueldos/rates chilenos queda en \textbf{CLP 9,89 MM--41,18 MM}. El costo económico total ---cash-out + oportunidad interna--- queda en \textbf{CLP 19,55 MM--91,72 MM}.

\section{Fuentes, tipo de cambio y metodología}
\begin{itemize}
\item UF consultada en mindicador.cl: CLP 40.611 por UF al 2026-05-31.
\item Dólar observado consultado en mindicador.cl: CLP 893 por USD, último dato disponible 2026-05-29.
\item Muestra rápida de avisos tech en Get on Board consultada el 2026-05-31: programación mostró mediana publicada aproximada de CLP 2,23--2,81 MM/mes; diseño CLP 1,61--1,92 MM/mes; data CLP 2,01--2,54 MM/mes; sysadmin/devops/QA mixto CLP 1,79--2,32 MM/mes.
\item Los rates horarios usados no son sueldo líquido: son equivalentes de planificación para reemplazar capacidad founder/interna por contratación senior, considerando carga empleador, seniority, gestión, fricción part-time y margen de consultoría.
\item Legal, seguridad y psicometría se tratan como rangos de planificación; antes de compra real habría que cotizar con proveedores chilenos.

\end{itemize}

\section{Rates y sueldos chilenos usados}
\small
\begin{tabularx}{\linewidth}{@{}p{4.3cm}p{3.1cm}p{3.2cm}X@{}}
\toprule
\rowcolor{KDark}\textcolor{white}{\textbf{Rol}} & \textcolor{white}{\textbf{Sueldo bruto mensual ref.}} & \textcolor{white}{\textbf{Rate planificación}} & \textcolor{white}{\textbf{Uso}} \\
\midrule
...
\section{Totales revisados para Chile}
\begin{tabularx}{\linewidth}{@{}L>{\raggedleft\arraybackslash}p{3.1cm}>{\raggedleft\arraybackslash}p{2.6cm}>{\raggedleft\arraybackslash}p{2.4cm}@{}}
\toprule
\rowcolor{KDark}\textcolor{white}{\textbf{Concepto}} & \textcolor{white}{\textbf{Rango CLP}} & \textcolor{white}{\textbf{UF}} & \textcolor{white}{\textbf{USD}} \\
\midrule
...
\subsection{Lectura por alcance}
\begin{itemize}
\item \textbf{H1--H3: staging + flujo candidato + recruiter básico:} CLP 0,91 MM--5,36 MM netos.
\item \textbf{H1--H4: agrega privacidad/compliance/seguridad mínima:} CLP 4,65 MM--20,98 MM netos.
\item \textbf{H1--H5: agrega piloto instrumentado y baseline inicial:} CLP 8,13 MM--37,29 MM netos.
\item \textbf{H1--H7: MVP/private beta completo:} CLP 9,66 MM--50,54 MM netos.
...
\small
\begin{longtable}{@{}p{5.3cm}p{3.1cm}p{3.3cm}p{3.3cm}p{2.8cm}p{3.3cm}@{}}
\toprule
\rowcolor{KDark}\textcolor{white}{\textbf{Hito}} & \textcolor{white}{\textbf{Original 05-28 convertido}} & \textcolor{white}{\textbf{Oportunidad interna Chile}} & \textcolor{white}{\textbf{Cash directo externo Chile}} & \textcolor{white}{\textbf{Contingencia}} & \textcolor{white}{\textbf{Cash-out recomendado Chile}} \\
\midrule
\endfirsthead
\toprule
\rowcolor{KDark}\textcolor{white}{\textbf{Hito}} & \textcolor{white}{\textbf{Original 05-28 convertido}} & \textcolor{white}{\textbf{Oportunidad interna Chile}} & \textcolor{white}{\textbf{Cash directo externo Chile}} & \textcolor{white}{\textbf{Contingencia}} & \textcolor{white}{\textbf{Cash-out recomendado Chile}} \\
...
\subsection{H1 --- Release candidate + staging deploy}
\textbf{Objetivo:} Pasar de repo local funcional a staging accesible y verificable fuera del entorno local.


\subsectionbar{Esfuerzo interno absorbido}
\small
\begin{tabularx}{\linewidth}{@{}L>{\raggedleft\arraybackslash}p{1.7cm}>{\raggedleft\arraybackslash}p{2.8cm}>{\raggedleft\arraybackslash}p{3.0cm}@{}}
\toprule
\rowcolor{KSoft}\textbf{Partida interna} & \textbf{Horas} & \textbf{Rate CLP/h} & \textbf{Valor oportunidad} \\
\midrule
...
QA smoke candidato $\to$ reporte $\to$ backend $\to$ recruiter & 6--12 h & CLP 14.000--28.000 & CLP 84.000--336.000 \\
...
\subsectionbar{Cash-out externo Chile}
\small
\begin{tabularx}{\linewidth}{@{}L>{\raggedleft\arraybackslash}p{3.1cm}X@{}}
\toprule
\rowcolor{KSoft}\textbf{Partida cash} & \textbf{Rango neto CLP} & \textbf{Nota} \\
\midrule
...
\end{tabularx}
\normalsize
\callout{KBlue}{\textbf{Comentario Chile.} En Chile este hito sigue siendo barato en cash si el equipo fundador ejecuta deploy y CI. El riesgo principal es no probar un flujo candidato$\to$backend$\to$recruiter en ambiente real.}

\subsection{H2 --- Candidate assessment MVP flow}
\textbf{Objetivo:} Dejar el flujo candidato listo para piloto real: invitación, consentimiento, batería corta, errores y cierre.
...
\end{tabularx}
\normalsize
\callout{KBlue}{\textbf{Comentario Chile.} El desarrollo puede absorberse internamente, pero conviene pagar pruebas con usuarios chilenos reales: cámara, consentimiento, duración y abandono suelen fallar fuera del equipo.}

\subsection{H3 --- Recruiter portal + reports/export v1}
\textbf{Objetivo:} Hacer usable el producto para cliente B2B sin mirar JSON ni depender del desarrollador.
...
\end{tabularx}
\normalsize
\callout{KBlue}{\textbf{Comentario Chile.} El cash más valioso no es construir UI, sino validar con recruiters chilenos si entienden límites, caveats, calidad de señal y qué NO inferir.}

\subsection{H4 --- Privacy/compliance/security hardening}
\textbf{Objetivo:} Reducir riesgo antes de exponer candidatos reales y conversaciones B2B serias.
...
\end{tabularx}
\normalsize
\callout{KBlue}{\textbf{Comentario Chile.} H4 es donde Chile no necesariamente abarata el cash-out: abogados de datos, seguridad y documentos para RRHH se cotizan caro y muchas veces en UF.}

\subsection{H5 --- Pilot instrumentation + baseline calibration}
\textbf{Objetivo:} Instrumentar piloto y baseline inicial sin vender predicción validada antes de datos reales.
...
\end{tabularx}
\normalsize
\callout{KBlue}{\textbf{Comentario Chile.} Este hito debe llamarse baseline inicial. Para Chile/LatAm, la confianza comercial depende más de una muestra honesta y caveats claros que de prometer scoring psicométrico fuerte.}

\subsection{H6 --- Pilot launch + customer operations}
\textbf{Objetivo:} Ejecutar pilotos reales con onboarding, soporte, feedback, triage y métricas de funnel.
...
\end{tabularx}
\normalsize
\callout{KBlue}{\textbf{Comentario Chile.} Si H5 ya cubre incentivos, no duplicarlos aquí. En Chile B2B conviene reservar caja para soporte humano cercano durante los primeros pilotos.}

\subsection{H7 --- MVP packaging / private beta comercial}
\textbf{Objetivo:} Convertir el piloto en una beta privada vendible: narrativa, pricing, docs y materiales comerciales.
...
\end{tabularx}
\normalsize
\callout{KBlue}{\textbf{Comentario Chile.} H7 puede ser barato si el fundador produce deck, pricing, landing y video. El tramo alto aparece al tercerizar video/diseño o hacer paid outreach.}


\clearpage
\section{Operación mensual chilena revisada}
\begin{tabularx}{\linewidth}{@{}L>{\raggedleft\arraybackslash}p{3.4cm}X@{}}
\toprule
\rowcolor{KDark}\textcolor{white}{\textbf{Categoría mensual}} & \textcolor{white}{\textbf{Rango neto CLP}} & \textcolor{white}{\textbf{Nota}} \\
\midrule
...
Total mensual neto recomendado & CLP 0,33 MM--1,98 MM & equivale a 8 UF--49 UF \\
Total mensual bruto si IVA no recuperable & CLP 0,39 MM--2,36 MM & escenario conservador de caja \\

\bottomrule
\end{tabularx}

\section{Recomendación para Chile}
\subsection{Demo/staging serio}
\begin{itemize}
\item Priorizar H1--H3. Cash-out neto: \textbf{CLP 0,91 MM--5,36 MM}.

\item Aún no abriría ampliamente a candidatos reales sin H4.
\end{itemize}
\subsection{Piloto real con candidatos chilenos}
\begin{itemize}
\item Priorizar H1--H5. Cash-out neto: \textbf{CLP 8,13 MM--37,29 MM}.

\item No recortar legal/privacy, seguridad, baseline/data ni soporte de piloto.
\item Mantener lenguaje: baseline inicial, apoyo a revisión humana, no decisión automática, no diagnóstico.
\end{itemize}
\subsection{Private beta comercial vendible}
\begin{itemize}
\item Completar H1--H7. Cash-out neto: \textbf{CLP 9,66 MM--50,54 MM}.

\item Para venta B2B chilena, presupuestaría caja real más cerca del tramo medio: CLP 20--40 MM netos.
\end{itemize}

\section{Partidas que sí se pueden comprimir en Chile}
\begin{itemize}
  \item Desarrollo externo general si el equipo fundador ejecuta.
  \item PM externo y coordinación de release.
  \item UX/copy básico y collateral comercial inicial.
  \item QA manual básica, manteniendo pruebas selectivas con usuarios y navegadores.
  \item Diseño/video si el equipo acepta un nivel founder-led para primera beta.
\end{itemize}

\section{Partidas que no conviene recortar}
\begin{itemize}
  \item Legal/privacy Chile: consentimiento, política, DPA, retención/eliminación y claims de RRHH.
  \item Security review/pentest ligero antes de candidatos reales.
  \item Backup/restore, monitoreo, secretos y logs.
  \item Baseline/calibración inicial con apoyo data/psicométrico local o LatAm.
  \item Incentivos/reclutamiento para feedback real.
  \item QA mínima en navegadores/dispositivos usados por candidatos chilenos.
\end{itemize}

\section{Conclusión}
La versión chilena del plan no debe leerse como una simple conversión USD$\to$CLP. Al usar sueldos y proveedores chilenos, la oportunidad interna baja frente al presupuesto profesionalizado original, pero el cash-out sano para piloto B2B sigue concentrado en legal, seguridad, psicometría/data, incentivos, infraestructura y operación.

El rango recomendado para completar el roadmap con equipo fundador absorbido es \textbf{CLP 9,66 MM--50,54 MM netos} (238 UF--1.245 UF), más \textbf{CLP 0,33 MM--1,98 MM mensuales netos} de operación. Para candidatos reales y clientes B2B, el presupuesto prudente está más cerca de \textbf{CLP 20--40 MM netos} antes de venderlo como private beta seria.
